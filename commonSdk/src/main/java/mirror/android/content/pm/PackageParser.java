...
public class PackageParser {
    ...
    @MethodReflectParams(value={"android.content.pm.PackageParser$Activity", "int"})
    ...
    @MethodReflectParams(value={"android.content.pm.PackageParser$Package", "[I", "int", "long", "long"})
    public static RefStaticMethod<PackageInfo> generatePackageInfo;
    @MethodReflectParams(value={"android.content.pm.PackageParser$Provider", "int"})
